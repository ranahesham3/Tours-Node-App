...
},{"@babel/polyfill":"dTCHC","./login":"7yHem","./updateSettings":"l3cGY","./mapbox":"3zDlz"}],"dTCHC":[function(require,module,exports,__globalThis) {
"use strict";
...
const updateSettings = async (data, type)=>{
    ...
    try {
        ...
        if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', `${type} is updated successfully`);
            window.setTimeout(()=>{
                //to go to home page
                location.reload();
            }, 1500);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf"}],"3zDlz":[function(require,module,exports,__globalThis) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayMap", ()=>displayMap);
const displayMap = (locations)=>{
    mapboxgl.accessToken = 'pk.eyJ1IjoicmFuYTAwNy0iLCJhIjoiY21jMHlpeWhlMDc2ejJqcjU3cXd6dWN2dyJ9.41b6xdrg4VjNDY6LGzdpRQ';
    //create a map
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["f5d4E","f2QDv"], "f2QDv", "parcelRequire11c7", {})
